 ...
 *
 * Psychology: Users falling asleep to music need the music to stop gracefully.
 * Abrupt stops are jarring — we fade out volume over the last 30 seconds.
 */
        ...
        intervalRef.current = setInterval(() => {
            setTimerState(prev => {
                ...
                if (remaining <= 30) {
                    ...
                    audioEngine.setVolume(fadedVolume);
                }
